...
class _ConnectDevicePageState extends State<ConnectDevicePage> {
  ...
  void _connectToDevice(BluetoothDevice device) async {
    ...
    try {
      ...
      if (_btSerialService != null && _serialRXCharacteristic != null && _serialTXCharacteristic != null) {
        print("Required services and characteristics found. Starting MyDeviceControlPage.");
        setState(() {
