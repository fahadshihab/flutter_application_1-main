  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Device Control', style: TextStyle(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                foregroundColor: Colors.black, backgroundColor: const Color.fromARGB(255, 255, 200, 0),
            ...
            ElevatedButton(
              onPressed: is_button_enabled? () {
                ...
                widget.serialTX.write(HandsPage.ascii.encode('E $speed_setting'));
                Future.delayed(const Duration(milliseconds: 2000), () {
                  setState(() {
                    is_button_enabled = true;
                  });
              ...
              style: ElevatedButton.styleFrom(
                foregroundColor: Colors.black, primary: const Color.fromARGB(255, 255, 180, 45),
                padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 15),
                textStyle: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10),
            ...
            ElevatedButton(
              onPressed: is_button_enabled? () {
                ...
                widget.serialTX.write(HandsPage.ascii.encode('C $cpm_reps_setting'));
                Future.delayed(Duration(milliseconds: 10000 * cpm_reps_setting), () {
                  setState(() {
                    is_button_enabled = true;
                  });
                });
